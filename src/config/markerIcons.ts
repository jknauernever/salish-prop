...
const SPECS: Record<string, IconSpec> = {
  ...
  // Bull kelp: the nautical-chart kelp squiggle (same mark as the legend swatch)
  kelp: {
    color: '#B89A3A',
    strokeGlyph: true,
    glyph: 'M3.5 9.5c2.8-4.5 5.7-4.5 8.5 0s5.7 4.5 8.5 0M3.5 15.5c2.8-4.5 5.7-4.5 8.5 0s5.7 4.5 8.5 0',
  },
  ...
  // Pilings: three posts of uneven height standing in the water
  piling: {
    color: '#5B5F97',
    glyph: 'M5.5 7h2.6v12H5.5zM10.7 4h2.6v15h-2.6zM15.9 8h2.6v11h-2.6zM3.5 19.3h17v1.7h-17z',
  },
  // Groin: a wall running out from the shore, waves either side
  groin: {
    color: '#7A6A53',
    glyph: 'M3 4h18v2.6H3zM10.7 6.6h2.6v9.4h-2.6zM2.6 18.6c1.6-1.2 3.2-1.2 4.8 0s3.2 1.2 4.8 0 3.2-1.2 4.8 0 3.2 1.2 4.8 0v2.6H2.6z',
  },
  // Marine railway: two rails running down into the water with three ties
  railway: {
    color: '#2F6F8F',
    strokeGlyph: true,
