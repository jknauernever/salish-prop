...
export const layerConfigs: LayerConfig[] = [
  ...
  // === Fish Habitat Layers ===
  {
    ...
    infoItems: [
      { label: 'Juvenile Chinook Salmon', text: 'Chinook salmon are listed as threatened under the Endangered Species Act. Nearshore habitat is critical for juvenile Chinook rearing and migration. Shoreline modification can reduce prey availability and disrupt migration corridors.' },
      { label: 'Juvenile Chum Salmon', text: 'Chum salmon depend on nearshore habitats during early marine life stages. Estuaries and pocket beaches provide critical transition zones where juveniles feed and grow before moving offshore.' },
      { label: 'Juvenile Pink Salmon', text: 'Pink salmon are the most abundant Pacific salmon species. Their juveniles spend minimal time in freshwater, making nearshore marine habitat especially critical during outmigration.' },
  ...
  // -- Shoreline --
  {
    ...
    popupFields: [
      ...
      { key: 'FISHuse_SF', label: 'Fish Use (shoreform unit)' },
